...
public class MainActivity extends AppCompatActivity implements View.OnKeyListener{
  ...
  public void swapLoginMode(View view){

    if (signUpModeActive){

      signUpModeActive = false;
      swapTextView.setText("or Sign Up");
      ...
      swapTextView.setText("or Log In");
        ...
        user.signUpInBackground(new SignUpCallback() {
          ...
          public void done(ParseException e) {
            if (e == null) {
              //OK
              goToUserListActivity();
              Toast.makeText(MainActivity.this, "You are Signed Up", Toast.LENGTH_SHORT).show();
